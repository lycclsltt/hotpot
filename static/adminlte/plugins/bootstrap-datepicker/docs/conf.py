...
latex_documents = [
    ('index', 'bootstrap-datepicker.tex',
     u'bootstrap-datepicker Documentation', u'eternicode', 'manual'),
]
...
man_pages = [('index', 'bootstrap-datepicker',
              u'bootstrap-datepicker Documentation', [u'eternicode'], 1)]
